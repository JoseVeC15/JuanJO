  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[60] flex items-center justify-center p-2 lg:p-4">
      <div className="bg-white rounded-[1.5rem] lg:rounded-[2.5rem] w-full max-w-4xl max-h-[95vh] lg:max-h-[90vh] overflow-hidden flex flex-col shadow-2xl relative">
        ...
        {/* Footer info */}
        <div className="p-4 lg:p-6 bg-slate-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
          <div className="flex items-center gap-3">
            <AlertCircle className={project.salud_margen === 'alerta' ? 'text-amber-400' : 'text-emerald-400'} size={20} />
            <p className="text-xs lg:text-sm">
              Tu margen: <span className="font-black">{project.margen_real_porc.toFixed(1)}%</span>. 
              {project.salud_margen === 'alerta' ? " Bajo objetivo." : " ¡Éxito!"}
            </p>
          </div>
